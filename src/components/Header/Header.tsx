...
const Header = React.forwardRef((props: HeaderProps, ref: Ref<any>) => {
    ...
    return (
        <Box className={clsx(classes.grow, className)}>
            <AppBar className={clsx(classes.appBar, className)}>
                <Toolbar>
                    ...
                    <Box className={clsx(classes.search, className)}>
                        <Box className={clsx(classes.searchIcon, className)}>
                            <SearchIcon/>
                        </Box>
                        <InputBase
                            placeholder="Search…"
                    ...
                    <Box className={clsx(classes.grow, className)}/>
                    <Box className={clsx(classes.sectionDesktop, className)}>
                        <IconButton aria-label="show 4 new mails" color="inherit">
                            <Badge badgeContent={4} color="secondary">
                                <MailIcon/>
                            </Badge>
                    ...
                    <Box className={clsx(classes.sectionMobile, className)}>
                        <IconButton
